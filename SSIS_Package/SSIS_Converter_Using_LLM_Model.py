...
from SSISAnalyzerAIPlugin import generate_ssis_summary
...
class SSISPackageAnalyzer:
    ...
    def analyze_all_packages(self, package_folder,output_folder):
            ...
            try:
                ...
                for package_path in package_files:
                    ...
                    try:
                        ...
                        try:
                            print("\n-------------------------------------------")
                            generate_ssis_summary(package_path,output_folder)
                            print("-------------------------------------------\n")
                        except Exception as e:
                            print(f"Failed to generate Summary through AI : {e}")
                            print("-------------------------------------------\n")
...
class Program:
    ...
    def main():
        ...
        analyzer.analyze_all_packages(package_folder,output_folder)
